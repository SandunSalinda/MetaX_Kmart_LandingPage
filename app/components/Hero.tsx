...
export default function Hero() {
  ...
  return (
    <section className={sectionClassName}>
      ...
      {/* Notification Container - Contained within hero section */}
      <div className="absolute top-4 left-1/2 transform -translate-x-1/2 z-50 pointer-events-none">
        {/* Success alert message */}
        {showSuccess && (
          <div className={`transform transition-all duration-500 ${alertPosition === 'in' ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'} bg-green-500 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg shadow-xl text-sm sm:text-base font-medium whitespace-nowrap`}>
        ...
        {/* Error alert message */}
        {showError && (
          <div className={`transform transition-all duration-500 ${alertPosition === 'in' ? 'translate-y-0 opacity-100' : '-translate-y-4 opacity-0'} bg-red-500 text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg shadow-xl text-sm sm:text-base font-medium whitespace-nowrap`}>
      ...
      <div className="absolute left-[50%] bottom-[-8%] 
                      w-[125px] h-[135px]
                      sm:hidden z-0"
           style={{ 
             transform: 'translateX(-50%) rotate(-12.03deg)',
